---
name: agtx
description: "Use when planning features, decomposing work into tasks, creating or managing tasks on a kanban board, or coordinating parallel coding agent sessions across git worktrees. Also use when asked about agtx setup, MCP configuration, or task workflow."
---
...
2. If it fails, the user needs to install agtx and register the MCP server:
   ```bash
   claude mcp add agtx -- agtx serve
   ```
